...
public class Combat implements java.io.Serializable{
	...
	public void toJSON(Writer w) throws Exception{
		...
		for(Unit u: this.involved_A) {
			u.toJSON(w);
			if(this.involved_A.indexOf(u) != this.involved_A.size() - 1)
				w.write(",");
		}
		w.write("],");
		...
		for(Unit u: this.involved_B) {
			u.toJSON(w);
			if(this.involved_B.indexOf(u) != this.involved_B.size() - 1)
				w.write(",");
		}
		w.write("],");
		...
		for(Unit u: this.involved_ALL) {
			u.toJSON(w);
			if(this.involved_ALL.indexOf(u) != this.involved_ALL.size() - 1)
				w.write(",");
		}
		w.write("],");
		...
		for(Unit u: this.remained_A) {
			u.toJSON(w);
			if(this.remained_A.indexOf(u) != this.remained_A.size() - 1)
				w.write(",");
		}
		w.write("],");
		...
		for(Unit u: this.remained_B) {
			u.toJSON(w);
			if(this.remained_B.indexOf(u) != this.remained_B.size() - 1)
				w.write(",");
		}
		w.write("],");
		...
		for(Unit u: this.remained_ALL) {
			u.toJSON(w);
			if(this.remained_ALL.indexOf(u) != this.remained_ALL.size() - 1)
				w.write(",");
		}
		w.write("],");
		...
		for(Unit u: this.killedUnits.keySet()) {
			...
			w.write("}");
			if(tmp < this.killedUnits.keySet().size())
				w.write(",");
		}
		w.write("],");
		...
		for(Unit u: this.passiveUnits) {
			u.toJSON(w);
			if(this.passiveUnits.indexOf(u) != this.passiveUnits.size() - 1)
				w.write(",");
		}
		w.write("]");
